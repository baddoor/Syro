...
export default {
    ...
    DECK_OPTIONS_SECTION_NEW_CARDS: "新卡片 (New Cards)",
    DECK_OPTIONS_LEARNING_STEPS: "初学间隔 (Learning Steps)",
    ...
    DECK_OPTIONS_SECTION_LAPSES: "遗忘 (Lapses)",
    DECK_OPTIONS_RELEARNING_STEPS: "重学间隔 (Relearning Steps)",
    DECK_OPTIONS_RELEARNING_STEPS_DESC:
        "间隔之间用空格分隔（如 10m）。支持 s(秒) m(分) h(时) d(天)",
    DECK_OPTIONS_SECTION_REVIEWS: "复习 (Reviews)",
