...
export default {
    ...
    GITHUB_ISSUES_MODIFIED_PLUGIN:
        'Сообщите о проблеме <a href="${issuesUrl}">здесь</a>, если у вас есть запрос на функцию, сообщение об ошибке или регрессия в Syro.',
    GITHUB_SOURCE_CODE:
        'Исходный код проекта доступен на <a href="${githubProjectUrl}">GitHub</a>.',
    CODE_CONTRIBUTION_INFO: 'Внести свой вклад в <a href="${codeContributionUrl}">код плагина</a>.',
    ...
    ALGORITHMS_DESC:
        'Алгоритм, используемый для интервального повторения. Для получения дополнительной информации см. <a href="https://github.com/baddoor/Syro/blob/main/docs/usage.md#algorithms">описание алгоритмов Syro</a>.',
    ...
    POST_ISSUE_MODIFIED_PLUGIN:
        'Сообщите о проблеме <a href="${issue_url}">здесь</a>, если вы нашли ошибку в настройках Syro.',

    // donation.ts
    DONATION_TEXT:
        "Syro продолжает активно развиваться. Обратная связь и отчеты об ошибках приветствуются.",
