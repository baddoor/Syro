...
- Use the closest maintained Chinese guide for the full walkthrough: [Open the Chinese guide](../../zh/advanced-and-faq/faq-troubleshooting.md)
- Return to the [English documentation hub](../index.md) when you need the broader map.

## What to expect here

- a short orientation for the page topic
- a stable permalink so the navigation stays valid
- a direct handoff to the Chinese detailed guide
